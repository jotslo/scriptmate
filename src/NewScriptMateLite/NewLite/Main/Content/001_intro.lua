...
Make sure you have opened the <b>Output</b> window, so you can see errors.]],
        ...
        Solution = [[-- this solution assigns 'myName' to the string 'Josh'
myName = "Josh"]]
    },
    {
        Type = "Exercise",
        ...
        ScriptValidator = "return true",
        Solution = [[-- this solution requires the number to be a DECIMAL, rather than a whole number
-- this is an example that assigns myNumber to the number 4.61
myNumber = 4.61]]
    },
    {
        Type = "Exercise",
        ...
        ScriptValidator = "return true",
        Solution = [[-- booleans are either true or false, as shown in the examples below
-- this is an example of a variable being assigned to a boolean data type
myBoolean = true]]
    },
    {
        Type = "Exercise",
        ...
        Solution = [[-- we declare a variable with the name myNewVariable and assign it the value "Hello!"
myNewVariable = "Hello!"

-- we print the value of myNewVariable to the output
print(myNewVariable)]]
    },
    {
        Type = "Exercise",
        ...
        Solution = [[-- josh is 19 today, so we assign the variable to the current age
joshAge = 19
...
print(joshAge)]]
    },
    {
        ...
        ScriptValidator = "return true",
        Solution = [[-- this challenge gives you freedom to choose any number of operations to perform
-- the only requirement is that the result is 100
-- below is one example of a solution that results in 100
print((30 - 5) * 2 + 50)]]
    },
    {
        Type =  "Quiz",
