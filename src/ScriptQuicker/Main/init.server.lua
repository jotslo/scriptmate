...
if runService:IsEdit() then
	local pluginTitle = "ScriptQuicker"
	...
	local button = toolbar:CreateButton("ScriptQuicker",
		"Enhance your scripting experience by auto-filling scripts with custom code snippets.",
		"rbxassetid://15238240081")
