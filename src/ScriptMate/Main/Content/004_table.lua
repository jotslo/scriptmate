...
module.Content = {
    {
        ...
        Solution = [[-- declare a table with no contents
local myTable = {}]]
    },
    {
        Type = "Exercise",
        ...
        ScriptValidator = "return true",
        Solution = [[-- declare myTable with list style contents
local myTable = {"s", 7, true, false}

--    myTable now looks like this:
--
--    index | value
--    ------+------
--    1     |   "s"
...
-- finally, we output the length of table
...
print(#myTable) -- 3]]
    },
    {
        ...
        Solution = [[-- declare dict-style table named 'ages'
...
print(ages.John) -- 3]]
    },
    {
        ...
        Solution = [[-- declare a table named 'myTable' with >2 values
local myTable = {"a", "b", "c"}
...
for index, value in myTable do
    ...
    },
    {
        ...
        ScriptValidator = "local _, count = userCode:gsub('print', '') return count == 1 and not userCode:find('print%(\\'') and not userCode:find('print%(\"')",
        Solution = [[-- assign myTable to a dictionary table
local myTable = {
    ["idx1"] = 3,
    idx2 = "yep"
}
